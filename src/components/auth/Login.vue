            ...
            <div class="col-lg-5">
              ...
              <div class="form-register mt-30 mb-30">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" v-model="form.email" placeholder="Vui lòng nhập email" @input="validateField('email')">
                  <div v-if="errors.email" class="error-message">{{ errors.email }}</div>
                </div>
                <div class="form-group">
                  <label class="mb-2 font-sm color-gray-700">Password <span class="note">*</span></label>
                  <input class="form-control" type="password" v-model="form.password" placeholder="Vui lòng nhập password" @input="validateField('password')">
