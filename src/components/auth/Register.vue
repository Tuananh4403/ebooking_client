            ...
            <div class="col-lg-5">
              ...
              <div class="form-register mt-30 mb-30">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" v-model="form.fullName" placeholder="Nguyễn Văn A" @input="validateField('fullName')">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" v-model="form.email" placeholder="a@gmail.com" @input="validateField('email')">
                  <div v-if="errors.email" class="error-message">{{ errors.email }}</div>
                </div>
                <div class="form-group">
                  <label class="mb-2 font-sm color-gray-700">Số điện thoại <span class="note">*</span></label>
                  <input class="form-control" type="text" v-model="form.phone" placeholder="09********" @input="validateField('phone')">
                  <div v-if="errors.phone" class="error-message">{{ errors.phone }}</div>
                </div>
                <div class="form-group">
                  <label class="mb-2 font-sm color-gray-700">Địa chỉ <span class="note">*</span></label>
                  <input class="form-control" type="text" v-model="form.address" placeholder="Đường A, Phường B, Thành phố C" @input="validateField('address')">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="password" v-model="form.password" placeholder="******************" @input="validateField('password')">
                  <div v-if="errors.password" class="error-message">{{ errors.password }}</div>
                </div>
                <div class="form-group">
                  <label class="mb-2 font-sm color-gray-700">Xác nhận mật khẩu <span class="note">*</span></label>
                  <input class="form-control" type="password" v-model="form.confirmPassword" placeholder="******************" @input="validateField('confirmPassword')">
                  <div v-if="errors.confirmPassword" class="error-message">{{ errors.confirmPassword }}</div>
                </div>
                <div class="form-group">
                  <input class="font-md-bold btn btn-buy" type="submit" value="Đăng kí" @click="handleSubmit">
                </div>
                <div class="mt-20"><span class="font-xs color-gray-500 font-medium">Bạn đã có tài khoản?</span><router-link class="font-xs color-brand-3 font-medium" to="/login">
                  Đăng nhập</router-link></div>
              </div>
            </div>
            <div class="col-lg-5">
              <div class="box-login-social pt-65 pl-50">
                ...
                <div class="box-button-login mt-25">
                  <a class="btn btn-login font-md-bold color-brand-3 mb-15">Đăng nhập với<img :src="imgs.google" alt="Ecom"></a>
                  <a class="btn btn-login font-md-bold color-brand-3 mb-15">Đăng nhập với<span class="color-blue font-md-bold">Facebook</span></a>
                  <a class="btn btn-login font-md-bold color-brand-3 mb-15">Đăng nhập với<img :src="imgs.amazon" alt="Ecom"></a>
                </div>
              </div>
            </div>
          </div>
