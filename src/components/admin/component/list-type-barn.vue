<template>
    <div class="content ">
      <div class="title-search-container">
        <h1 class="title">DANH SÁCH LOẠI CHUỒNG</h1>
      ...
      <AddUpdateBarnType v-if="showModal" :barnTypeId="isCreating ? null : selectedCompetitionId" @close="closeModal" />
    </div>
  </template>
  
  
  <script>
  import AddUpdateBarnType from "@/components/admin/component/add-update-type-barn.vue";
  ...
  export default {
    ...
    methods: {
      ...
      fetchLocation() {
        this.loading = true;
        storeApiPrivate.get('/api/BarnType?api-version=1.0', {
          params: {
